...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
	String attack = JOptionPane.showInputDialog("Attack with a yell or a kick?");
			...
			// 		dragon.
				String health = "Your health is: " + playerHealth + " (-" + dragonAttack + " health) The Dragon's health is: " + dragonHealth + " (-" + playerAttack + " health)";
	...
	static void playerLost() {
		...
		JOptionPane.showMessageDialog(null, "You were defeated by the dragon and lost the treasure.");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "You defeated the dragon and gained a ton of gold!");
		System.exit(0);   //This code ends the program
	}
